...
![Version: 0.60.7](https://img.shields.io/badge/Version-0.60.7-informational?style=flat-square) ![AppVersion: v0.1.0](https://img.shields.io/badge/AppVersion-v0.1.0-informational?style=flat-square)
...
| container_images.app_cert_manager.cert_manager.image.tag | string | `"v1.13.3"` |  |
...
| container_images.app_kube_prometheus_stack.grafana.image.tag | string | `"12.0.2-security-01@sha256:9047b1d7ec7bfad6a7e6542e7f1782b2337e18af8ebf4f21cf5327e903dac830"` |  |
