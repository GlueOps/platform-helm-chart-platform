...
![Version: 0.50.0](https://img.shields.io/badge/Version-0.50.0-informational?style=flat-square) ![AppVersion: v0.1.0](https://img.shields.io/badge/AppVersion-v0.1.0-informational?style=flat-square)
...
| container_images.app_metacontroller.metacontroller.image.tag | string | `"v4.11.19@sha256:69c52ceabcbeb5f3d27f4eff3a0fc8616650830d3f77441e834aae424614e0b2"` |  |
