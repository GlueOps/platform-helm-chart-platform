...
![Version: 0.78.0](https://img.shields.io/badge/Version-0.78.0-informational?style=flat-square) ![AppVersion: v0.1.0](https://img.shields.io/badge/AppVersion-v0.1.0-informational?style=flat-square)
...
| container_images.app_backup_and_exports.certs_backup_restore.image.tag | string | `"v2.3.4@sha256:bd246e59076bd76329ff1126a07da5f7429ef4307c4153d4986b2201035a8283"` |  |
...
| container_images.app_cert_manager.cert_restore.image.tag | string | `"v2.3.4@sha256:bd246e59076bd76329ff1126a07da5f7429ef4307c4153d4986b2201035a8283"` |  |
...
| internal_lb.additional_ports.tcp.expose.default | bool | `true` |  |
| internal_lb.additional_ports.tcp.exposedPort | int | `54320` |  |
| internal_lb.additional_ports.tcp.port | int | `54320` |  |
| internal_lb.additional_ports.tcp.protocol | string | `"TCP"` |  |
| internal_lb.shared_helm_values.additionalArguments[0] | string | `"--metrics.prometheus=true"` |  |
| internal_lb.shared_helm_values.additionalArguments[1] | string | `"--metrics.prometheus.addEntryPointsLabels=true"` |  |
| internal_lb.shared_helm_values.additionalArguments[2] | string | `"--metrics.prometheus.addRoutersLabels=true"` |  |
| internal_lb.shared_helm_values.additionalArguments[3] | string | `"--metrics.prometheus.addServicesLabels=true"` |  |
| internal_lb.shared_helm_values.additionalArguments[4] | string | `"--metrics.prometheus.addServicesLabels=true"` |  |
| internal_lb.shared_helm_values.additionalArguments[5] | string | `"--serversTransport.insecureSkipVerify=true"` |  |
| internal_lb.shared_helm_values.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution[0].podAffinityTerm.labelSelector.matchExpressions[0].key | string | `"app.kubernetes.io/name"` |  |
| internal_lb.shared_helm_values.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution[0].podAffinityTerm.labelSelector.matchExpressions[0].operator | string | `"In"` |  |
| internal_lb.shared_helm_values.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution[0].podAffinityTerm.labelSelector.matchExpressions[0].values[0] | string | `"traefik"` |  |
| internal_lb.shared_helm_values.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution[0].podAffinityTerm.topologyKey | string | `"kubernetes.io/hostname"` |  |
| internal_lb.shared_helm_values.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution[0].weight | int | `100` |  |
| internal_lb.shared_helm_values.api.dashboard | bool | `true` |  |
| internal_lb.shared_helm_values.experimental.plugins.redirectErrors.moduleName | string | `"github.com/indivisible/redirecterrors"` |  |
| internal_lb.shared_helm_values.experimental.plugins.redirectErrors.version | string | `"v0.1.0"` |  |
| internal_lb.shared_helm_values.image.registry | string | `"dockerhub.repo.gpkg.io"` |  |
| internal_lb.shared_helm_values.image.repository | string | `"traefik"` |  |
| internal_lb.shared_helm_values.image.tag | string | `"v3.6.7@sha256:a9890c898f379c1905ee5b28342f6b408dc863f08db2dab20e46c267d1ff463a"` |  |
| internal_lb.shared_helm_values.logs.access.enabled | bool | `true` |  |
| internal_lb.shared_helm_values.logs.access.format | string | `"json"` |  |
| internal_lb.shared_helm_values.logs.general.format | string | `"json"` |  |
| internal_lb.shared_helm_values.logs.general.level | string | `"INFO"` |  |
| internal_lb.shared_helm_values.metrics.prometheus.addEntryPointsLabels | bool | `true` |  |
| internal_lb.shared_helm_values.metrics.prometheus.addRoutersLabels | bool | `true` |  |
| internal_lb.shared_helm_values.metrics.prometheus.addServicesLabels | bool | `true` |  |
| internal_lb.shared_helm_values.metrics.prometheus.service.enabled | bool | `true` |  |
| internal_lb.shared_helm_values.metrics.prometheus.serviceMonitor.enabled | bool | `true` |  |
| internal_lb.shared_helm_values.resources.requests.cpu | string | `"100m"` |  |
| internal_lb.shared_helm_values.resources.requests.memory | string | `"90Mi"` |  |
| internal_lb.shared_helm_values.tlsStore.default.defaultCertificate.secretName | string | `"default-ingress-cert"` |  |
...
| traefik.internal_lb | object | `{"additional_ports":{},"deployment_replicas":"placeholder_traefik_internal_lb_deployment_replicas","enabled":"placeholder_traefik_enable_internal_lb"}` | number of replicas for traefik controller |
| traefik.platform_lb.additional_ports | object | `{}` |  |
| traefik.platform_lb.deployment_replicas | int | `2` |  |
| traefik.public_lb.additional_ports | object | `{}` |  |
...
| traefik.shared_additional_ports.tcp.expose.default | bool | `true` |  |
| traefik.shared_additional_ports.tcp.exposedPort | int | `54320` |  |
| traefik.shared_additional_ports.tcp.port | int | `54320` |  |
| traefik.shared_additional_ports.tcp.protocol | string | `"TCP"` |  |
| traefik.shared_ports.traefik.expose.default | bool | `true` |  |
| traefik.shared_ports.web.expose.default | bool | `true` |  |
| traefik.shared_ports.web.exposedPort | int | `80` |  |
| traefik.shared_ports.web.forwardedHeaders.insecure | bool | `true` |  |
| traefik.shared_ports.web.transport.lifeCycle.graceTimeOut | string | `"240s"` |  |
| traefik.shared_ports.web.transport.lifeCycle.requestAcceptGraceTimeout | string | `"240s"` |  |
| traefik.shared_ports.websecure.expose.default | bool | `true` |  |
| traefik.shared_ports.websecure.exposedPort | int | `443` |  |
| traefik.shared_ports.websecure.forwardedHeaders.insecure | bool | `true` |  |
| traefik.shared_ports.websecure.transport.lifeCycle.graceTimeOut | string | `"240s"` |  |
| traefik.shared_ports.websecure.transport.lifeCycle.requestAcceptGraceTimeout | string | `"240s"` |  |
